<x-layout>
    ...
    <x-tambah-barang-keluar-modal :gudangs="$gudangs" />
    @if ($transaksies->isNotEmpty())
        {{-- Modal Export --}}
        <x-export-barang-keluar-modal />
    @endif
    @if ($editTransaksi && !$errors->any() && !session('error'))
        {{-- Modal Ubah Transaksi --}}
        <x-ubah-barang-keluar-modal :gudangs="$gudangs" :transaksi="$editTransaksi" :editTransaksiSatuan="$editTransaksiSatuan" />
