            ...
            <div class="flex flex-grow">
                ...
                <div class="relative w-full flex">
                    <input type="search" id="search-dropdown" name="search"
                        ...
                        placeholder="Cari Transaksi Item Transfer" value="{{ request('search') }}" />
                    <button type="submit"
            ...
            <thead class="text-xs text-gray-700 bg-gray-50 sticky top-0 shadow-md">
                <tr>
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'created_at', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            TANGGAL BUAT
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'updated_at', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            TANGGAL UBAH
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'gudang_asal', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            GUDANG ASAL
                            @if (request('sort_by') === 'gudang_asal')
                                @if (request('direction') === 'asc')
                                    <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'gudang_tujuan', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            GUDANG TUJUAN
                            @if (request('sort_by') === 'gudang_tujuan')
                                @if (request('direction') === 'asc')
                                    <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'nama_item', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            NAMA BARANG
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'jumlah_stok_transfer', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            JUMLAH STOK TRANSFER
                            @if (request('sort_by') === 'jumlah_stok_transfer')
                                @if (request('direction') === 'asc')
                                    <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'keterangan', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            KETERANGAN
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'user_buat_id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            USER BUAT
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('itemtransfer.index', array_merge(request()->query(), ['sort_by' => 'user_update_id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            USER UPDATE
            ...
            <tbody>
                @forelse ($transaksies as $transaksi)
                    <tr class="odd:bg-white even:bg-gray-50 border-b">
                        ...
                        <td class="px-6 py-4 align-middle">{{ $transaksi['gudang_asal'] }}</td>
                        <td class="px-6 py-4 align-middle">{{ $transaksi['gudang_tujuan'] }}</td>
                        <td class="px-6 py-4 align-middle">{{ $transaksi['nama_item'] }}</td>
                        <td class="px-6 py-4 align-middle">{{ $transaksi['jumlah_stok_transfer'] }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="9" class="px-6 py-4 text-center text-gray-500">Data Transaksi Item Transfer
                            tidak ditemukan.
                        </td>
                    </tr>
                @endforelse
