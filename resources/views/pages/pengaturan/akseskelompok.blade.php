<x-layout>
    ...
    <form action="{{ route('akseskelompok.update') }}?{{ http_build_query(request()->only(['role'])) }}"" method="POST"
        x-data="{ role_id: '{{ request('role_id') }}' }">
        @csrf
        @method('PUT')
        <div class="mb-4">
                        ...
                        <tr class="odd:bg-white even:bg-gray-50 border-b">
                            ...
                            <td class="px-6 py-4 align-middle">
                                @if (in_array('akses', $feature['actions']))
                                    <input type="checkbox" name="permissions[{{ $feature['feature'] }}.akses]"
                            ...
                            <td class="px-6 py-4 align-middle">
                                @if (in_array('read', $feature['actions']))
                                    <input type="checkbox" name="permissions[{{ $feature['feature'] }}.read]"
                                        class="form-checkbox text-blue-600"
                            ...
                            <td class="px-6 py-4 align-middle">
                                @if (in_array('create', $feature['actions']))
                                    <input type="checkbox" name="permissions[{{ $feature['feature'] }}.create]"
                                        class="form-checkbox text-blue-600"
                            ...
                            <td class="px-6 py-4 align-middle">
                                @if (in_array('update', $feature['actions']))
                                    <input type="checkbox" name="permissions[{{ $feature['feature'] }}.update]"
                                        class="form-checkbox text-blue-600"
                            ...
                            <td class="px-6 py-4 align-middle">
                                @if (in_array('delete', $feature['actions']))
                                    <input type="checkbox" name="permissions[{{ $feature['feature'] }}.delete]"
                                        class="form-checkbox text-blue-600"
                            ...
                            <td class="px-6 py-4 align-middle">
                                @if (in_array('export', $feature['actions']))
                                    <input type="checkbox" name="permissions[{{ $feature['feature'] }}.export]"
                                        class="form-checkbox text-blue-600"
