<x-layout>
    ...
    <div class="flex items-center p-4 mb-4 text-base text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800"
        role="alert">
        ...
        <div>
            <span class="font-medium">Perhatian:</span> Data Log Aktivitas Yang Disimpan Hanya 6 Bulan Terakhir.
        </div>
    </div>
