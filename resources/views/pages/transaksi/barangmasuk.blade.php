<x-layout>
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        @endif
        @if ($transaksies->isNotEmpty() && $canExportBarangMasuk)
            ...
            <thead class="text-xs text-gray-700 bg-gray-50 sticky top-0 shadow-md">
                <tr>
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'created_at', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            TANGGAL BUAT
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'updated_at', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            TANGGAL UBAH
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'kode_gudang', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            GUDANG
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'nama_item', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            NAMA BARANG
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'jumlah_stok_masuk', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            JUMLAH STOK MASUK
                            @if (request('sort_by') === 'jumlah_stok_masuk')
                                @if (request('direction') === 'asc')
                                    <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'keterangan', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            KETERANGAN
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'user_buat_id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            USER BUAT
                    ...
                    <th scope="col" class="px-6 py-3 bg-gray-50">
                        <a href="{{ route('barangmasuk.index', array_merge(request()->query(), ['sort_by' => 'user_update_id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}"
                            class="flex justify-center items-center">
                            USER UPDATE
                    ...
                    @if ($canUpdateBarangMasuk || $canDeleteBarangMasuk)
    ...
    @endif
    @if ($editTransaksi && !$errors->any() && !session('error') && $canUpdateBarangMasuk)
    ...
    @elseif ($deleteTransaksi && !$errors->any() && !session('error') && $canDeleteBarangMasuk)
