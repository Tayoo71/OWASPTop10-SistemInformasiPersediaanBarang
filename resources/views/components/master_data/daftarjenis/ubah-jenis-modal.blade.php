<x-modal.modal-update title="Ubah Jenis">
    <form method="POST"
        action="{{ route('daftarjenis.update', $jenis->id) }}?{{ http_build_query(request()->only(['search', 'sort_by', 'direction'])) }}"
        class="p-4 md:p-5">
        @csrf
        @method('PUT')
        <div class="grid gap-4 mb-4">
            <div class="col-span-2">
                ...
                <input type="text" name="nama_jenis" id="nama_jenis"
                    ...
                    placeholder="Masukkan Nama Jenis" value="{{ $jenis->nama_jenis }}" required>
            </div>
            ...
            <div class="col-span-2">
                ...
                <textarea id="keterangan" name="keterangan" rows="3"
                    ...
                    placeholder="Masukkan Keterangan">{{ $jenis->keterangan }}</textarea>
            </div>
        </div>
