...
<div tabindex="-1" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto" x-data>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Autentikasi Dua Faktor (2FA) telah berhasil diaktifkan. Pastikan untuk mencatat dan menyimpan kode
                ...
                <div class="flex justify-center">
                    <button type="button" @click="window.location.href = '{{ route('home_page') }}';"
