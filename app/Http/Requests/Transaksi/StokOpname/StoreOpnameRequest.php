...
class StoreOpnameRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'stok_fisik.required' => 'Jumlah stok masuk wajib diisi.',
            'stok_fisik.integer' => 'Jumlah stok masuk harus berupa angka.',
            'stok_fisik.min' => 'Jumlah stok masuk tidak boleh kurang dari 1.',
