...
class ExportStokOpnameRequest extends FormRequest
{
    use LogActivity;
    /**
    ...
    {
        return $this->user()->can('stok_opname.export');
    }
    ...
    protected function failedValidation(Validator $validator)
    {
        ...
        $logMessage = 'Terjadi Kesalahan Validasi pada Cetak & Konversi Transaksi Stok Opname. Errors: ' . $errorDetails;
